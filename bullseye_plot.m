...
% function [h,t]=bullseye_plot(data,varargin)
function fig=bullseye_plot(data,varargin)
fig = figure;
...
label{1}='anterolateral';
label{2}='anterior';
label{3}='anteroseptal';
label{4}='inferoseptal';
label{5}='inferior';
label{6}='inferolateral';
% label{1}='anterior';
